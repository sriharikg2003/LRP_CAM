...
import torch
from my_captum.attr._utils.stat import Count, Max, Mean, Min, MSE, Stat, StdDev, Sum, Var
...
class Summarizer:
    ...
    def update(self, x: Union[float, Tensor, Tuple[Union[float, Tensor], ...]]):
        ...
        from my_captum._utils.common import _format_float_or_tensor_into_tuples
